...
import { Fragment, useState, useEffect, useRef } from "react";  // ← add useEffect, useRef
...
export const Navbar = () => {
  ...
  const [isVisible, setIsVisible] = useState(true);   // ← tracks show/hide
  const lastScrollY = useRef(0);                       // ← tracks previous scroll position
