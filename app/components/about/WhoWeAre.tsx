        ...
        <section className="w-full bg-primary grid grid-cols-1 md:grid-cols-2 items-stretch min-h-[400px]">
                <div className="flex flex-col justify-center py-20 pl-[10%] pr-10 md:pr-20">
                    <div className="max-w-[600px]">
                        <Typography variant="h3" className="relative inline-block after:content-[''] after:absolute after:-bottom-1 after:right-[-10px] after:w-20 after:h-[1.5px] after:bg-black">Who We Are</Typography>
