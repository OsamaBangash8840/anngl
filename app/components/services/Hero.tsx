...
export const Hero = () => {
    const t = useTranslations("common.services.hero");
    return (
        <>
        <section
         style={{
        ...
        className=" ">
            <div className=" py-16">
                <Typography variant="hDisplay" className=" relative -ml-[7%] text-center z-90 w-full !font-semibold">{t("title1")} <br/> {t("title2")}</Typography>
