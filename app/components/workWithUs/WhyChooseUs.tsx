    ...
    return (
        <section className=" grid grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr] mt-20 pb-8 md:pb-1 ">
            ...
            <div className="bg-[#204A60]  ">
                ...
                <Typography className=" text-center pb-4 md:pb-0 md:px-8 px-1 mt-6">We give you the trust of customers as a certified partner of Transport that supports your reputation in the market.</Typography>
            </div>
            <div className="bg-[#ADAEB1]">
                <Image src={'/images/whyChooseUsIcon3.svg'} alt="" width={40} height={40} className="mx-auto mb-4 mt-16" />
                <Typography className="text-center pb-4 md:pb-0 md:px-8 px-1 mt-6">You can track and manage your orders efficiently and seamlessly through the smart system on the Move platform.</Typography>
            </div>
        </section>
    );
};